...
class InventoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post inventories_url, params: { inventory: { name: @inventory.name, price: @inventory.price, quantity: @inventory.quantity } }
    end
  ...
  test "should update inventory" do
    patch inventory_url(@inventory), params: { inventory: { name: @inventory.name, price: @inventory.price, quantity: @inventory.quantity } }
