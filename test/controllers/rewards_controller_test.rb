...
class RewardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post rewards_url, params: { reward: { balance: @reward.balance, user_id: @reward.user_id } }
    end
  ...
  test "should update reward" do
    patch reward_url(@reward), params: { reward: { balance: @reward.balance, user_id: @reward.user_id } }
