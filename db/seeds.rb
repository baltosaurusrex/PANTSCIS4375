...
Item.create! :name=>"Amy", :price=>3.00, :quantity=>10, :description=>"this wonderful top is not lorem ipsum", :itemtype=>"Top"
Item.create! :name=>"Josie", :price=>4.00, :quantity=>10, :description=>"this wonderful bottom is not lorem ipsum", :itemtype=>"Bottom"
Item.create! :name=>"Alice", :price=>5.00, :quantity=>10, :description=>"this wonderful dress is not lorem ipsum", :itemtype=>"Dress"
